...
\begin{itemize}
\item
  \textbf{Abstention} (State_0 = absent): A \emph{behavioral}
...
\item
  \textbf{Ignorance} (\(K_1 = -1\) with State_0 = correct): A
...
\((K_0, K_1, K_2)\) & HMeta-d \approx  aggregate \(K_1\) sensitivity \\
...
the Fr'echet-Hoeffding bounds, the maximum joint probability is
\(\min(\pi, p)\), yielding:
